...
import { useDeleteProductsMutation } from "../../redux/feature/product/productApi";
                ...
                <div className="w-full bg-white px-5 py-3 rounded overflow-x-auto">
                    <table className="w-full">
                        ...
                        {productData.length > 0 ? (
                            <tbody>
                                {productData.map((product: TProductProps) => (
                                    <tr
                                        key={product._id}
                                        ...
                                        <td className="px-[2px] py-2">
                                            <div>
                                                <button
                                                    ...
                                                    className="bg-[var(--secondary-color)] text-[var(--primary-color)] text-center rounded-md p-2 w-[60px] font-bold"
                                                >
                                                    Sell
                                                </button>
                                            </div>
